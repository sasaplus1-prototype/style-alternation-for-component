...
const classnames = __webpack_require__(13);

const style = __webpack_require__(14);

const cx = classnames.bind(style); // NOTE: base class
...
class RedArea extends React.Component {
  render() {
    return React.createElement(BaseArea, _extends({
      className: cx('red')
    }, this.props));
  }
...
class App extends React.Component {
  render() {
    return React.createElement("div", null, React.createElement(RedArea, null, "RedArea, based on BaseArea"), React.createElement(BlueArea, null, "BlueArea, based on BaseArea"));
  }
...
if (true) {
  (function () {
    ...
    var checkPropTypes = __webpack_require__(5); // TODO: this is special because it gets imported during build.
 ...
 * This source code is licensed under the MIT license found in the
 * LICENSE file in the root directory of this source tree.
 */if(true){(function(){'use strict';var React=__webpack_require__(2);var _assign=__webpack_require__(4);var checkPropTypes=__webpack_require__(5);var schedule=__webpack_require__(9);var tracing=__webpack_require__(11);/**
 * Use invariant() to assert state which your program assumes to be true.
 *
 * Provide sprintf-style format (only %s is supported) and arguments
 * to provide information about what broke and what you were
...
module.exports = {"area":"lj0kh_09jPZXVZf7Z58f2","red":"_3fvh6G_91gDVbv0X0dKJvD","blue":"_9IvHaY2olJvTHI42EN4rC"};
